...
const rows: Row[] = [
  {
    ...
    parikshaa: "AI-personalized sprints with daily goals",
    others: "Static, non-adaptive curriculum",
    hero: true,
  },
  {
    kicker: "02",
    feature: "AI Mentorship",
    parikshaa: "Socratic guidance (Tufy) that builds intuition",
    others: "Direct answers or generic chatbots",
  },
  {
    kicker: "03",
    feature: "Company Practice",
    parikshaa: "Real questions from the last 90 days",
    others: "Outdated, archived problem sets",
  },
  {
    kicker: "04",
    feature: "Code Feedback",
    parikshaa: "AI-powered line-by-line review & notes",
    others: "Simple pass/fail test cases",
  },
  {
    kicker: "05",
    feature: "Concept Mastery",
    parikshaa: "Visual execution player & revision snippets",
    others: "Textual explanations & static diagrams",
  },
  {
    kicker: "06",
    feature: "Aptitude Bank",
    parikshaa: "2000+ topic-wise questions with explainers",
    others: "Focus only on DSA · no comprehensive prep",
  },
];
