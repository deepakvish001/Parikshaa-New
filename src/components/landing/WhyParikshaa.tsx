...
const pillars: Pillar[] = [
  {
    id: "01",
    title: "AI Roadmaps",
    tagline: "Custom goal-based sprints. Tell us your target company and timeline, we build the plan.",
    meta: "Personalized · Data-driven",
    icon: Zap,
    tag: "Sprints",
  },
  {
    id: "02",
    title: "Socratic AI",
    tagline: "Tufy doesn't give answers. It asks the right questions to build your intuition.",
    meta: "Mastery · Intuition",
    icon: Sparkles,
    tag: "Mentor",
  },
  {
    id: "03",
    title: "Company Intel",
    tagline: "FAANG-focused practice. Filter problems by company and recent frequency.",
    meta: "Career · Targeted",
    icon: ShieldCheck,
    tag: "Intel",
  },
  {
    ...
    tagline: "Build a habit with POTD and real-time tracking across coding platforms.",
    meta: "Habits · Consistency",
    icon: Gauge,
    tag: "Streaks",
  },
  {
    ...
    tagline: "See the recursion tree and memory state as you execute your solutions.",
    meta: "Visual · Deep Dive",
    icon: Trophy,
    tag: "Visuals",
  },
  {
    id: "06",
    title: "Review Notes",
    tagline: "Auto-generated revision notes and quizzes after every major milestone.",
    meta: "Retention · Logic",
    icon: Users,
    tag: "Revision",
  },
];
